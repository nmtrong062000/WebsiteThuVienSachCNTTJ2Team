<%@ Page Title="QUẢN TRỊ MẠNG" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="QuanTriMang.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.QuanTriMang" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DoAn_LTW %>" SelectCommand="SELECT [MaSach], [TenSach], [HinhMinhHoa], [MaCD] FROM [SACH] where MaCD=5"></asp:SqlDataSource>
