...
<script src="../JAVASCRIPT/KiemTraGopY.js">
</script>
</head>
    ...
    <div class="content">
        <article>
            ...
            <div class="gopy">
            		...
            		<h1>Góp Ý</h1>
                    <form action="#" name="dangky" method="post" onsubmit="return KiemTraGopY()">
                      
                    	<table>
                        	<tr>
                        	<td>Họ Và Tên:</td>
                            <td><input id="hoten" type="text" name="txtTenDangNhap" /></td>
                          	</tr>
                          	<tr>
                            <td>Email:</td>
                      ...
                      <div align="center">
                            <button id="btngui" type="submit" onclick="return KiemTra()">Gửi</button>
