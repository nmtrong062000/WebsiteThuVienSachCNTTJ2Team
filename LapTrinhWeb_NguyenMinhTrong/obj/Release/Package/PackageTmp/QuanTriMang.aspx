<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuanTriMang.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.QuanTriMang" %>
...
<title>J2TEAM LIBRARY - QUẢN TRỊ MẠNG</title>
...
<div class="main">
    ...
    <div class="content">
        <article>
        	...
        	<section>
            	<div class="tab">
                	<button class="tablinks active">quản trị mạng</button>
                    <div class="timkiem">
                <input type="text" class="timkiem_input" name="timkiem" placeholder="Nhập nội dung cần tìm kiếm..."/>
                <input type="image" src="../Images/search.png" class="timkiem_bt"/>
            </div>
                ...
                <!--sach moi nhat-->
                <div class="noidungtabs" id="quantrimang">
                	<div class="sach">
                    	<p class="tensach"><a href="#">Giáo Trình Nhập Môn Mạng Máy Tính</a></p>
                        <img class="hinhsach" src="../Images/Sach/giao-trinh-mang-may-tinh-ho-dac-phuong.pdf-0.jpg"/>
