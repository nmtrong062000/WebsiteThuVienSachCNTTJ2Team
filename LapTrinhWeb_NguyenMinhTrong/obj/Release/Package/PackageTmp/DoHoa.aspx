<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoHoa.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.DoHoa" %>
...
<div class="main">
    ...
    <div class="content">
        <article>
        	...
        	<section>
            	<div class="tab">
                	<button class="tablinks active">đồ hoạ</button>
                    <div class="timkiem">
                <input type="text" class="timkiem_input" name="timkiem" placeholder="Nhập nội dung cần tìm kiếm..."/>
                <input type="image" src="../Images/search.png" class="timkiem_bt"/>
            </div>
                ...
                <!--sach moi nhat-->
                <div class="noidungtabs" id="dohoa">
                	<div class="sach">
                    	<p class="tensach"><a href="ChiTietSachAutoCad.aspx">Giáo Trình Tự Học AutoCad 2019</a></p>
                        <img class="hinhsach" src="../Images/Sach/autocad.png"/>
                        <a href="ChiTietSachAutoCad.aspx"><img class="nutdownload" src="../Images/dowload-button.png" /></a>
                    </div>
                    <div class="sach">
                    	<p class="tensach"><a href="ChiTietSachPSCS6.aspx">Tự Học Thiết Kế Đò Hoạ Trên PhotoShop 2019</a></p>
