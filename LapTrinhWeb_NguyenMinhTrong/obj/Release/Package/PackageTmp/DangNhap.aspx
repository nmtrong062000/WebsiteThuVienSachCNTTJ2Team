        ...
        <article>
            ...
            <div class="dangnhap1">
                    <div class="frmdangnhap" runat="server">
                        ...
                        <h1>Đăng Nhập</h1>
                        <form action="#" method="post" onsubmit="return KiemTraDangNhap()" runat="server">
                            <p>Tên tài khoản:</p>
                            <asp:TextBox CssClass="style" ID="taikhoan" runat="server"></asp:TextBox>
                            <!--<input id="taikhoan" type="text" name=""  />-->
                            <p>Mật khẩu:</p>
                            <asp:TextBox CssClass="style" ID="matkhau" runat="server" TextMode="Password"></asp:TextBox>
                            <!--<input id="matkhau" type="password" name="" />-->
                            <asp:Button id="btndangnhap" runat="server" Text="Đăng Nhập" PostBackUrl="~/Default.aspx" ></asp:Button>
                            <!--OnClick="btndangnhap_Click"-->
                            <!--<button id="btndangnhap" type="submit" onclick="return KiemTra()">Đăng Nhập</button>-->
                            <br />
                            <a href="#">Quên mật khẩu?</a><br>
                            <div>Nếu chưa có tài khoản vui lòng đăng ký <a href="DangKy.aspx"><i>tại đây</i></a></div>
                        </form>
                    </div>
            </div>
            </section>
