<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSachCSS_HTML.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.ChiTietSachCSS_HTML" %>
        ...
        <article>
        	...
        	<section>
            	<div class="chitietsach">
                	<table border="1">
  					<tr>
    					<td colspan="2" id="cttensach">css and html web design</td>
  					</tr>
  					<tr>
    					<td rowspan="6"><div align="center"><img src="../Images/Sach/html_css.jpg" width="250" height="350" /></div></td>
    					<td>Tác giả:<i> Craig Grannell</i></td>
  					</tr>
  					<tr>
    					<td>Đồng tác giả:</td>
  					</tr>
  					...
  					<tr>
    					<td>Nhà xuất bản: <b>Nhà xuất bản Apress</b></td>
  					</tr>
                    <tr>
    					<td>Năm xuất bản: <i>2008</i></td>
  					</tr>
  					<tr>
  					...
  					<tr>
                    	<td colspan="2"><p><b>Nội dung của cuốn:</b></p>
                            <p>CSS and HTML Web Design gồm có 10 chương:</p>
                            <div class="noidungsach">
                                <p>Chương 1: An intriduction to Web design</p>
                                <p>Chương 2: Web page essentials</p>
                                <p>Chương 3: Working with type</p>
                                <p>Chương 4: Working with images</p>
                                <p>Chương 5: Using links and creating navigation</p>
                                <p>Chương 6: Tables: How nature (and the W3C) intended</p>
                                <p>Chương 7: Page layouts with css</p>
                                <p>Chương 8: Getting user feedback</p>
                                <p>Chương 9: Dealing with browser quirks</p>
                                <p>Chương 10: Putting everything together</p>
                            </div>
