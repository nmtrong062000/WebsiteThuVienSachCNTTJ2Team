<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LienHe.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.LienHe" %>
...
<title>J2TEAM LIBRARY - LIÊN HỆ</title>
        	...
        	<section>
            	<div class="lienhe">
                    ...
                    <div class="thongtinlienhe">
                    	<p id="tieude">Thư viện sách CNTT J2Team Library</p>
                        <br />
                        <br />
                        <p>Số 340/20, phường Phú Hoà, Thủ Dầu Một Bình Dương</p>
                        <p>Điện thoai: 0989919899</p>
                        <p>Fax: 0909911989</p>
                        <p>Email: <a href="mailto:J2TEAMLIBRARY@GMAIL.COM">j2teamlibrary@gmail.com</a></p>
                        <p>Facebook: <a href="https://www.facebook.com/groups/j2team.community"> https://www.facebook.com/groups/j2team.community </a></p>
                    </div>
                </div>
        	</section>
        </article>
