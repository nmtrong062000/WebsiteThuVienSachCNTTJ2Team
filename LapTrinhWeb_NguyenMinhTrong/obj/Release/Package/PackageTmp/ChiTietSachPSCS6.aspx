<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSachPSCS6.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.ChiTietSachPSCS6" %>
        ...
        <article>
        	...
        	<section>
            	<div class="chitietsach">
                	<table border="1">
  					<tr>
    					<td colspan="2" id="cttensach">Tự Học Thiết Kế Đồ Họa Trên Photoshop CS6</td>
  					</tr>
  					<tr>
    					<td rowspan="6"><div align="center"><img src="../Images/Sach/PSCS6.jpg" width="250" height="350" /></div></td>
    					<td>Tác giả:<i> Nguyễn Đức Hiếu</i></td>
  					</tr>
  					<tr>
    					<td>Đồng tác giả:</td>
  					</tr>
                    ...
                    <tr>
  					...
  					<tr>
                    	<td colspan="2"><p><b>Nội dung của cuốn:</b></p>
                            <p>Tự Học Thiết Kế Đồ Họa Trên Photoshop CS6 gồm có :</p>
