<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThietKeWeb.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.ThietKeWeb" %>
...
<div class="main">
    ...
    <div class="content">
        <article>
        	...
        	<section>
            	<div class="tab">
                	<button class="tablinks active">thiết kế web</button>
                    <div class="timkiem">
                <input type="text" class="timkiem_input" name="timkiem" placeholder="Nhập nội dung cần tìm kiếm..."/>
                <input type="image" src="../Images/search.png" class="timkiem_bt"/>
            </div>
                ...
                <!--sach moi nhat-->
                <div class="noidungtabs" id="thietkeweb">
                	<div class="sach">
                    	<p class="tensach"><a href="ChiTietSachTKW.aspx">Hướng Dẫn Thiết Kế Website</a></p>
                        <img class="hinhsach" src="../Images/Sach/hd_thiet_ke_web_1.jpg"/>
                        <a href="ChiTietSachTKW.aspx"><img class="nutdownload" src="../Images/dowload-button.png" /></a>
                    </div>
                    <div class="sach">
