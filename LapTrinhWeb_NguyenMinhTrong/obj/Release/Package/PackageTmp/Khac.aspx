<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Khac.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.Khac" %>
...
<title>J2TEAM LIBRARY - KHÁC</title>
...
<div class="main">
    ...
    <div class="content">
        <article>
        	...
        	<section>
            	<div class="tab">
                	<button class="tablinks active">khác</button>
                    <div class="timkiem">
                <input type="text" class="timkiem_input" name="timkiem" placeholder="Nhập nội dung cần tìm kiếm..."/>
                <input type="image" src="../Images/search.png" class="timkiem_bt"/>
            </div>
                ...
                <div class="noidungtabs" id="khac">
                    ...
                    <div class="sach">
                    	<p class="tensach"><a href="#">Lập Trình Và Cuộc Sống</a></p>
                        <img class="hinhsach" src="../Images/Sach/laptrinhvacuocsong.jpg"/>
                        <a href="#"><img class="nutdownload" src="../Images/dowload-button.png" /></a>
                    </div>
                    <div class="sach">
