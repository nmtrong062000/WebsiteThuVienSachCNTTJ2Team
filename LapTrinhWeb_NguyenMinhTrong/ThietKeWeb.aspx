<%@ Page Title="THIẾT KẾ WEB" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ThietKeWeb.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.ThietKeWeb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DoAn_LTW %>" SelectCommand="SELECT [MaSach], [TenSach], [HinhMinhHoa], [MaCD] FROM [SACH] where MaCD=2"></asp:SqlDataSource>
