<%@ Page Title="NGÔN NGỮ LẬP TRÌNH" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="NgonNguLapTrinh.aspx.cs" Inherits="LapTrinhWeb_NguyenMinhTrong.NgonNguLapTrinh" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DoAn_LTW %>" SelectCommand="SELECT [MaSach], [TenSach], [HinhMinhHoa], [MaCD] FROM [SACH] where MaCD=1"></asp:SqlDataSource>
